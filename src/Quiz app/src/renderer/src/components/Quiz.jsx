...
function Quiz({
  ...
  useEffect(() => {
    window.api.readHighscores().then(data => setHighscores(data || []))
  }, [])
  ...
  return (
    <div>
      ...
      {/* prints feedback */}
      <div style={counter === 0 && mode === 'easy' ? {'display':'none'}:{}}  
      className="feedback w-[15ch] break-words text-center text-xl">
        {feedback}
        {' '}
        {timerMessage}{' '}
        {mode === 'hard' && (
