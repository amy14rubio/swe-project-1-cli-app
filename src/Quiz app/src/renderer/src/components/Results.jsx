...
function UserInputForm({ quizName, quizType, score, inputScreen, setInputScreen }) {
  ...
  return (
    <div className="popup" style={inputScreen===0?{'display':'none'}:{}}>
      ...
      {inputScreen === 1 && (
        <div>
          <h3 className="text-2xl w-[20ch] break-words text-center mt-4">Congrats you made it to highscores!</h3>
          <form className="text-center" onSubmit={ handleSubmit }>
            <label className="text-xl" htmlFor="userInput">Enter your name:</label>
            <br />
            <input
            ...
            />
            <br />
            <button className="text-lg mt-4" type="submit">Submit</button>
          </form>
        </div>
      )}
      ...
      {inputScreen === 2 && (
        <div>
          <h1 className="text-3xl w-[15ch] break-words text-center mt-4"> View your score on the highscore board!</h1>
        </div>
      )}
